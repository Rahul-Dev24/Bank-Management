...
<%@page import = "com.user.admin.FetchBalance" %>
        ...
        <table class="table">
            <thead class="fourth-dark">
                <tr>
                    ...
                    <th scope="col"  style="background-color: rgb(184, 106, 76); color: #fff;">Trans-id</th>
                    <th scope="col"  style="background-color: rgb(184, 106, 76); color: #fff;">amount</th>
                </tr>
            </thead>
            <tbody>
            <% List<FetchBalance> userData = (List<FetchBalance>)session.getAttribute("adminbalance"); 
			      for(FetchBalance data1 : userData){%> 
                <tr>
                    ...
                    <td style="background-color: rgb(221, 195, 171); color: #000;"><%= data1.getBalance() %></td>
                </tr>
                <%} %>
            </tbody>
        </table>
